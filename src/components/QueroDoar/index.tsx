      ...
      <S.Main>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <S.DivUpload>
            ...
            <S.DivLabelImg>
              <S.LabelImg id="label-input-file" htmlFor="input-file">
                Procurar imagem
              </S.LabelImg>
              <S.Input
                type="file"
          ...
          <S.InputText
            ...
            value={formik.values.nomeDoPet}
            placeholder="Insira o nome do pet"
            id="nomeDoPet"
            name="nomeDoPet"
            type="text"
          />
          <S.LabelInputText htmlFor="descricaoDoPet">
            Descrição
          </S.LabelInputText>
          <S.TextArea
            onChange={formik.handleChange}
            value={formik.values.descricaoDoPet}
          ...
          <S.Button type="submit">
            Incluir pet <S.ImgButton src={holdingHeart} />
          </S.Button>
        </form>
      </S.Main>
    </>
